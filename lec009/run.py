...
if __name__ == "__main__":
    ...
    torch.save(model_state, "artifacts/models/tap30nn.pth")

    loaded_model = Tap30NN()
    loaded_model_state = torch.load("artifacts/models/tap30nn.pth")
    loaded_model.load_state_dict(loaded_model_state)
    y_pred = loaded_model(features)
    print(y_pred)
